...
class _ShimmerBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final highlightColor = AppTheme.cardDark.withValues(alpha: 0.8);
    return Container(
      width: width,
      height: height,
      decoration: BoxDecoration(
...
/// A full-screen shimmer state used during AI search.
class ShimmerSearchState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: List.generate(3, (i) => const ShimmerCard()),
    );
  }
}
