...
final RegExp pakPhoneRegex = RegExp(r'^03\d{9}$');

final List<TextInputFormatter> pakPhoneInputFormatters = [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            errorBorder: OutlineInputBorder(
              borderRadius: AppTheme.radiusMd,
              borderSide:
                  const BorderSide(color: AppTheme.redError, width: 1.5),
            ),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
            child: Text(message,
                style:
                    const TextStyle(color: AppTheme.redError, fontSize: 13))),
      ]),
...
class AuthSectionHeader extends StatelessWidget {
  ...
  const AuthSectionHeader(
      {super.key, required this.title, this.color = AppTheme.tealPrimary});
