...
class WorkerNotificationService {
  ...
  /// Called when a user selects a worker and sends a service request.
  Future<void> notifyNewRequest({
    ...
    await _col(workerUid)?.add({
      ...
      'body':
          '$customerName requested you for $serviceType on $scheduledDate at $scheduledTime — Rs.${quotedPricePkr.toInt()}. Please approve or suggest another time.',
      'is_read': false,
      'created_at': FieldValue.serverTimestamp(),
      'meta': {
