...
/// Screens rebuild when language changes by calling setState after [setLanguage].
class LanguageService {
  ...
  Future<void> init() async {
    ...
    _isUrdu = p.getBool('app_lang_urdu') ?? false;
  }
...
class S {
  ...
  // ── Role Select ─────────────────────────────────────────────────────────
  static String get appTagline    => _l.t("Pakistan's Smartest Home Services", "پاکستان کی سب سے ذہین گھریلو خدمت");
  static String get whoAreYou     => _l.t("Who are you?", "آپ کون ہیں؟");
  static String get selectRole    => _l.t("Select your role to continue", "جاری رکھنے کے لیے اپنا کردار منتخب کریں");
  ...
  static String get noAccount     => _l.t("Don't have an account? Register", "اکاؤنٹ نہیں ہے؟ رجسٹر کریں");
  ...
  static String get voiceBookSub  => _l.t("Let our assistant find the perfect worker", "ہمارا معاون آپ کا بہترین کارکن تلاش کرے گا");

  // ── Agents (shown in search progress panel) ─────────────────────────────
  static String get agentIntent     => _l.t("Understanding your request",      "آپ کی درخواست سمجھ رہے ہیں");
  static String get agentMatching   => _l.t("Finding workers near you",         "آپ کے قریب کارکن تلاش کر رہے ہیں");
  static String get agentSurge      => _l.t("Checking demand in your area",     "آپ کے علاقے میں مانگ جانچ رہے ہیں");
  static String get agentPricing    => _l.t("Calculating the best price",       "بہترین قیمت تیار کر رہے ہیں");
  static String get agentScheduling => _l.t("Checking worker availability",     "کارکن کی دستیابی جانچ رہے ہیں");
  static String get agentBooking    => _l.t("Confirming your booking",          "آپ کی بکنگ تصدیق ہو رہی ہے");
  static String get agentDispute    => _l.t("Reviewing your complaint",         "آپ کی شکایت کا جائزہ لیا جا رہا ہے");
  static String get agentFeedback   => _l.t("Saving your feedback",             "آپ کی رائے محفوظ ہو رہی ہے");
